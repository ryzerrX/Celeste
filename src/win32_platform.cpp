...
bool platform_create_window(int width, int height, char *title)
{
    ...
    {
        // Add in the border size of the widow
        {
            RECT borderRect = {};
        ...
        const int pixelAttribs[] =
        {
            ...
            0 // Terminate with 0, otherwise OpenGL with throw an Error!  
        };
        ...
        if(!wglChoosePixelFormatARB(dc, pixelAttribs,
                                    ...
                                    &numPixelFormats))
        {
            SM_ASSERT(0, "Failed to wglChoosPixelFormatARB");
            return false;
        }
...
void* platform_load_dynamic_function(void* dll, char* funName)
{
    ...
    SM_ASSERT(proc, "Failed to load dll: %s from DLL",funName);
